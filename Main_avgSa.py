...
fig_dir = r"C:\Users\mb-com.me\Desktop\Record_selection_Nevena\Summer_school\Figures"  # directory where the figures are stored
output_dir = r"C:\Users\mb-com.me\Desktop\Record_selection_Nevena\Summer_school\output"  # directory where pkl and mat are saved
mat_dir = r"C:\Users\mb-com.me\Desktop\Databases\New_January22\DB_final_5.mat"  # mat file with records
path_dis = r"C:\Users\mb-com.me\Desktop\Scaling\Hazard_avgSa\output_Dis\For_Python_0.2_1.5"  # output from OQ
path_haz = r"C:\Users\mb-com.me\Desktop\Scaling\Hazard_avgSa\output_PSHA\For_Python"  # output from OQ
...
T_star = np.arange(0.2, 1.6, 0.1)  # periods of interest
...
for j in range(nIM):
    ...
    CS1.create(site_param={'vs30': Vs30},
                                    ...
                                    dist_param={'rjb': [rjb]}, Hcont=None, T_Tgt_range=T_target, im_T_star=im_T_star,
